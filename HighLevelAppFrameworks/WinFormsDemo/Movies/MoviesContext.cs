...
namespace WinFormsDemo.Movies
{
    public partial class MoviesContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(config.GetConnectionString("MoviesDbConnection"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>(entity =>
            {
                ...
                entity.HasMany(d => d.Genres)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "MovieGenre",
                        l => l.HasOne<Genre>().WithMany().HasForeignKey("GenreId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("movie_genres$fk_mg_genre"),
                        r => r.HasOne<Movie>().WithMany().HasForeignKey("MovieId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_movie_genres_movie"),
                        j =>
                        {
                            j.HasKey("MovieId", "GenreId").HasName("PK_movie_genres_movie_id");

                            j.ToTable("movie_genres");

                            j.HasIndex(new[] { "GenreId" }, "fk_mg_genre");

                            j.HasIndex(new[] { "MovieId" }, "fk_mg_movie");
